...
{
    draw_text(round(xx + lengthdir_x(argument3, dto_i)), round(yy + lengthdir_y(argument3, dto_i)), string_hash_to_newline(argument2));
}

draw_set_color(dto_dcol);

draw_text(round(xx), round(yy), string_hash_to_newline(argument2));
