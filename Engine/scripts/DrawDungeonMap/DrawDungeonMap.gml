...

{
    ...
    for(var i = 0; i < ds_list_size(layers); ++i)
    {
        ...
        draw_set_color(iff(i == mapLayer, c_aqua, c_white));
        draw_rectangle(
            layersLeft, yy,
            layersLeft + 60, yy + 12,
            false
        ...
        draw_text(layersLeft + 4, yy + 2, string_hash_to_newline(concat("L", i + 1)));
    ...
    for(var yy = 0; yy < height; ++yy)
    {
        ...
        for(var xx = 0; xx < width; ++xx)
        {
            ...
            {
                if (!revealed && ds_list_find_index(visited, concat(mapLayer, mc)) == -1)
                    continue;
            }
