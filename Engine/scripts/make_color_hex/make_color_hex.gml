...

{
    ...
    var r1, r2, g1, g2, b1, b2, r, g, b, form;
    
    //Check to see if a # was used and adapt to the given form
    ...
    r1 = string_char_at(argument0,2-form);
    r2 = string_char_at(argument0,3-form);
    g1 = string_char_at(argument0,4-form);
    g2 = string_char_at(argument0,5-form);
    b1 = string_char_at(argument0,6-form);
    b2 = string_char_at(argument0,7-form);
