/// @description  LoadMapData(region, relative-path);
...

{
    ...
    {
        var mapLayer = ds_list_create();
            ds_list_add(mapLayer, tmpMaps[| i]);
            ds_list_add(mapLayer, tmpDoors[| i]);
        ds_list_add(entry, mapLayer);
    }
